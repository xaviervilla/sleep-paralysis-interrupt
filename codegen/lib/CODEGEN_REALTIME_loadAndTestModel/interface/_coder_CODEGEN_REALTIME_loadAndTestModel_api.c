 ...
 *
 * _coder_CODEGEN_REALTIME_loadAndTestModel_api.c
 *
...
/* Include files */
#include "_coder_CODEGEN_REALTIME_loadAndTestModel_api.h"
#include "_coder_CODEGEN_REALTIME_loadAndTestModel_mex.h"
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "CODEGEN_REALTIME_loadAndTestModel", /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void CODEGEN_REALTIME_loadAndTestModel_api(const mxArray * const prhs[6],
  int32_T nlhs, const mxArray *plhs[1])
{
  ...
  real_T (*body_gyro_x_test)[256];
  real_T (*body_gyro_y_test)[256];
  real_T (*body_gyro_z_test)[256];
  ...
  total_acc_z_test = emlrt_marshallIn(&st, emlrtAlias(prhs[2]),
    "total_acc_z_test");
  body_gyro_x_test = emlrt_marshallIn(&st, emlrtAlias(prhs[3]),
    "body_gyro_x_test");
  body_gyro_y_test = emlrt_marshallIn(&st, emlrtAlias(prhs[4]),
    "body_gyro_y_test");
  body_gyro_z_test = emlrt_marshallIn(&st, emlrtAlias(prhs[5]),
    "body_gyro_z_test");

  /* Invoke the target function */
  CODEGEN_REALTIME_loadAndTestModel(*total_acc_x_test, *total_acc_y_test,
    *total_acc_z_test, *body_gyro_x_test, *body_gyro_y_test, *body_gyro_z_test, *
    label);
...
void CODEGEN_REALTIME_loadAndTestModel_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CODEGEN_REALTIME_loadAndTestModel_xil_terminate();
  CODEGEN_REALTIME_loadAndTestModel_xil_shutdown();
...
void CODEGEN_REALTIME_loadAndTestModel_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_CODEGEN_REALTIME_loadAndTestModel_api.c) */
