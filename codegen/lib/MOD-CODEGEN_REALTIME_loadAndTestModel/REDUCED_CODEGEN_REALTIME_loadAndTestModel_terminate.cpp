 ...
 * File: REDUCED_CODEGEN_REALTIME_loadAndTestModel_terminate.c
 *
...
void REDUCED_CODEGEN_REALTIME_loadAndTestModel_terminate(void)
{
  ...
  isInitialized_REDUCED_CODEGEN_REALTIME_loadAndTestModel = false;
}

/*
 * File trailer for REDUCED_CODEGEN_REALTIME_loadAndTestModel_terminate.c
 *
 * [EOF]
 */
