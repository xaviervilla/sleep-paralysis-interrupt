...
## Build Info:
## 
## Final product: ./loadAndTestModel.lib
...
PRODUCT_NAME              = loadAndTestModel
MAKEFILE                  = loadAndTestModel_rtw.mk
MATLAB_ROOT               = /usr/local/MATLAB/R2019b
MATLAB_BIN                = /usr/local/MATLAB/R2019b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/glnxa64
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/xvilla/Documents/2019fall/195/my\ classifier/codegen/lib/loadAndTestModel
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = loadAndTestModel_rtw_comp.rsp
CMD_FILE                  = loadAndTestModel_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = loadAndTestModel.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=loadAndTestModel -DHAVESTDIO -DUSE_RTMODEL -DUNIX
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=loadAndTestModel -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
loadAndTestModel_data.o : $(START_DIR)/loadAndTestModel_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


loadAndTestModel_initialize.o : $(START_DIR)/loadAndTestModel_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


loadAndTestModel_terminate.o : $(START_DIR)/loadAndTestModel_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


loadAndTestModel.o : $(START_DIR)/loadAndTestModel.c
	$(CC) $(CFLAGS) -o "$@" "$<"
